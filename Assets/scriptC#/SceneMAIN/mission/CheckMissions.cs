...
public class CheckMissions : MonoBehaviour
{
    ...
    public static bool finishedday;
    ...
    public TextMeshProUGUI[] missionsJour2 = new TextMeshProUGUI[3];  // Taille du tableau défini à 3
    ...
    void Update()
    {
        if (VRCanvasController.numjours == 2)
        {   
            missionsJour2[0].text = "Tirer sur les \rasteroides pour les détruire";
            missionsJour2[1].text = "Equiper le casque";
            missionsJour2[2].text = "Relier les cables a l'arrière du vaisseau a gauche";
            texteCheckMark1.text = missionsJour2[0].text;
            texteCheckMark2.text = missionsJour2[1].text;
            texteCheckMark3.text = missionsJour2[2].text;
        }
        ValiderMissions();
    }
    ...
    // Méthode pour réinitialiser l'état des missions
    public void ResetMissionState()
    {
        if (monCheckMark1 != null) monCheckMark1.isOn = false;
        if (monCheckMark2 != null) monCheckMark2.isOn = false;
        if (monCheckMark3 != null) monCheckMark3.isOn = false;
    }
}
